...
`,Vh=[{value:"bug",label:"Bug"},{value:"feature",label:"Feature"},{value:"future",label:"Future Idea (Later Version)"}];function Kh(i="bug",f="",s="idle",o="",h=!1,m=[],p=!1,b=!0,S=!1,v="",x=!1){const _=Vh.map(Y=>`<option value="${Y.value}" ${Y.value===i?"selected":""}>${Y.label}</option>`).join(""),R=s==="loading",N=R,B=s==="error"&&!S;return s==="success"?`
  ...
  `}let Lf=null;function Jh(i){if(!i||typeof i!="object")throw new Error("FeedbackWidget.init() requires a configuration object");const f=i;if(!f.appId)throw new Error("FeedbackWidget.init() requires appId to be specified");if(typeof f.appId!="string")throw new Error("FeedbackWidget.init() appId must be a string");if(f.appId.trim()==="")throw new Error("FeedbackWidget.init() appId cannot be empty");if(f.position!==void 0){const s=["bottom-right","bottom-left","top-right","top-left"];if(!s.includes(f.position))throw new Error(`FeedbackWidget.init() position must be one of: ${s.join(", ")}`)}if(f.jwtConfig!==void 0&&typeof f.jwtConfig!="object")throw new Error("FeedbackWidget.init() jwtConfig must be an object");if(f.env!==void 0){if(typeof f.env!="string")throw new Error("FeedbackWidget.init() env must be a string");const s=["alpha","beta","dev","stable"];if(!s.includes(f.env))throw new Error(`FeedbackWidget.init() env must be one of: ${s.join(", ")}`)}if(f.apiBaseUrl!==void 0&&typeof f.apiBaseUrl!="string")throw new Error("FeedbackWidget.init() apiBaseUrl must be a string")}function Fi(i){var f;Jh(i),Lf={appId:i.appId,position:(f=i.position)!=null?f:"bottom-right",jwtConfig:i.jwtConfig,env:i.env,apiBaseUrl:i.apiBaseUrl}}function $h(){return Lf}const Yf="feedback-widget-corner";function Wh(i){try{localStorage.setItem(Yf,i)}catch(f){console.warn("FeedbackWidget: Unable to save position to localStorage")}}function jf(){try{const i=localStorage.getItem(Yf);return i&&["bottom-right","bottom-left","top-right","top-left"].includes(i)?i:null}catch(i){return null}}function Fh(i,f){const s=typeof window!="undefined"?document.documentElement.clientWidth:800,o=typeof window!="undefined"?document.documentElement.clientHeight:600,h=i<s/2,m=f<o/2;return m&&h?"top-left":m&&!h?"top-right":!m&&h?"bottom-left":"bottom-right"}const Sl=56,Dt=24;let Jl=(typeof window!="undefined"?jf():null)||"bottom-right";const Ii=new Set;let ba=!1,gu=!1,Pi=!1,gn={x:0,y:0},yu=null;function Ih(){yu=null}function $l(){Ih();for(const i of Ii)i()}function Gf(i){if(typeof window=="undefined")return{x:0,y:0};const f=document.documentElement.clientWidth,s=document.documentElement.clientHeight;switch(i){case"top-left":return{x:Dt,y:Dt};case"top-right":return{x:f-Sl-Dt,y:Dt};case"bottom-left":return{x:Dt,y:s-Sl-Dt};default:return{x:f-Sl-Dt,y:s-Sl-Dt}}}let ec=!1;function Ph(i="bottom-right"){if(ec)return;am(),Jl=jf()||i,ec=!0,$l()}function em(){ba=!0,gn=Gf(Jl),$l()}function tm(i,f){ba&&(gn={x:i,y:f},$l())}function lm(){if(!ba)return;const i=gn.x+Sl/2,f=gn.y+Sl/2,s=Fh(i,f);ba=!1,gu=!0,$l(),setTimeout(()=>{Jl=s,Wh(s),yn=null,vu=null,gu=!1,Pi=!0,$l(),setTimeout(()=>{Pi=!1,$l()},150)},50)}let yn=null,vu=null,tc=0,lc=0,Xf=!1;function am(){Xf||typeof window=="undefined"||(Xf=!0,window.addEventListener("resize",()=>{const i=document.documentElement.clientWidth,f=document.documentElement.clientHeight;(i!==tc||f!==lc)&&(tc=i,lc=f,yn=null,vu=null,$l())}),tc=document.documentElement.clientWidth,lc=document.documentElement.clientHeight)}function nm(){return ba||gu?gn:((yn===null||vu!==Jl)&&(yn=Gf(Jl),vu=Jl),yn)}function um(i){return Ii.add(i),()=>{Ii.delete(i)}}function im(){return yu===null&&(yu={corner:Jl,position:nm(),isDragging:ba,isSnapping:gu,isAnimatingToCorner:Pi,isInitialized:ec}),yu}const cm={corner:"bottom-right",position:{x:0,y:0},isDragging:!1,isSnapping:!1,isAnimatingToCorner:!1,isInitialized:!1};function om(){return cm}function fm(i){const f=K.useSyncExternalStore(um,im,om),{position:s,isDragging:o,isSnapping:h,isInitialized:m,corner:p,isAnimatingToCorner:b}=f;return K.useLayoutEffect(()=>{Ph(i)},[i]),{widgetPosition:s,isDragging:o,isSnapping:h,isInitialized:m,corner:p,isAnimatingToCorner:b,widgetState:f}}function rm({widgetPosition:i,isExpanded:f}){const s=K.useRef(!1),o=K.useRef(null),h=K.useRef(null),m=K.useRef(!1),p=K.useRef(!1),b=K.useRef(()=>{}),S=K.useCallback(_=>{_.button!==0||f||(s.current=!0,m.current=!1,p.current=!1,o.current={x:_.clientX,y:_.clientY},h.current=pt({},i))},[i,f]);b.current=S;const v=K.useCallback(_=>{if(!s.current||!o.current||!h.current)return;const R=_.clientX-o.current.x,N=_.clientY-o.current.y;if((Math.abs(R)>5||Math.abs(N)>5)&&(m.current=!0,p.current||(p.current=!0,em())),!p.current)return;const B=document.documentElement.clientWidth,Y=document.documentElement.clientHeight,k=Math.max(Dt,Math.min(h.current.x+R,B-Sl-Dt)),j=Math.max(Dt,Math.min(h.current.y+N,Y-Sl-Dt));tm(k,j)},[]),x=K.useCallback(()=>{s.current&&p.current&&lm(),s.current=!1,p.current=!1,o.current=null,h.current=null},[]);return K.useEffect(()=>(document.addEventListener("mousemove",v),document.addEventListener("mouseup",x),()=>{document.removeEventListener("mousemove",v),document.removeEventListener("mouseup",x)}),[v,x]),{handleMouseDownRef:b,hasDraggedRef:m}}function sm({setIsExpanded:i,setSelectionWarning:f}){const[s,o]=K.useState(!1),h=K.useRef(!1);h.current=s,K.useEffect(()=>{const b=S=>{S.key==="Escape"&&s&&o(!1)};if(s)return document.addEventListener("keydown",b),()=>document.removeEventListener("keydown",b)},[s]);const m=K.useCallback(()=>{o(!0),i(!1)},[i]),p=K.useCallback(()=>{o(!1),i(!0),f(null)},[i,f]);return{isSelectionMode:s,setIsSelectionMode:o,isSelectionModeRef:h,handleEnterSelectionMode:m,handleExitSelectionMode:p}}const Qf="[modern-screenshot]",pa=typeof window!="undefined",dm=pa&&"Worker"in window,ac=pa?(Sr=window.navigator)==null?void 0:Sr.userAgent:"",Zf=ac.includes("Chrome"),bu=ac.includes("AppleWebKit")&&!Zf,nc=ac.includes("Firefox"),hm=i=>i&&"__CONTEXT__"in i,mm=i=>i.constructor.name==="CSSFontFaceRule",gm=i=>i.constructor.name==="CSSImportRule",Jt=i=>i.nodeType===1,vn=i=>typeof i.className=="object",Vf=i=>i.tagName==="image",ym=i=>i.tagName==="use",bn=i=>Jt(i)&&typeof i.style!="undefined"&&!vn(i),vm=i=>i.nodeType===8,bm=i=>i.nodeType===3,Sa=i=>i.tagName==="IMG",pu=i=>i.tagName==="VIDEO",pm=i=>i.tagName==="CANVAS",Sm=i=>i.tagName==="TEXTAREA",Em=i=>i.tagName==="INPUT",xm=i=>i.tagName==="STYLE",Tm=i=>i.tagName==="SCRIPT",zm=i=>i.tagName==="SELECT",wm=i=>i.tagName==="SLOT",Am=i=>i.tagName==="IFRAME",Mm=(...i)=>console.warn(Qf,...i);function _m(i){var s;const f=(s=i==null?void 0:i.createElement)==null?void 0:s.call(i,"canvas");return f&&(f.height=f.width=1),!!f&&"toDataURL"in f&&!!f.toDataURL("image/webp").includes("image/webp")}const uc=i=>i.startsWith("data:");function Kf(i,f){if(i.match(/^[a-z]+:\/\//i))return i;if(pa&&i.match(/^\/\//))return window.location.protocol+i;if(i.match(/^[a-z]+:/i)||!pa)return i;const s=Su().implementation.createHTMLDocument(),o=s.createElement("base"),h=s.createElement("a");return s.head.appendChild(o),s.body.appendChild(h),f&&(o.href=f),h.href=i,h.href}function Su(i){var f;return(f=i&&Jt(i)?i==null?void 0:i.ownerDocument:i)!=null?f:window.document}const Eu="http://www.w3.org/2000/svg";function Dm(i,f,s){const o=Su(s).createElementNS(Eu,"svg");return o.setAttributeNS(null,"width",i.toString()),o.setAttributeNS(null,"height",f.toString()),o.setAttributeNS(null,"viewBox",`0 0 ${i} ${f}`),o}function Cm(i,f){let s=new XMLSerializer().serializeToString(i);return f&&(s=s.replace(/[\u0000-\u0008\v\f\u000E-\u001F\uD800-\uDFFF\uFFFE\uFFFF]/gu,"")),`data:image/svg+xml;charset=utf-8,${encodeURIComponent(s)}`}function Om(i,f){return new Promise((s,o)=>{const h=new FileReader;h.onload=()=>s(h.result),h.onerror=()=>o(h.error),h.onabort=()=>o(new Error(`Failed read blob to ${f}`)),h.readAsDataURL(i)})}const Um=i=>Om(i,"dataUrl");function Ea(i,f){const s=Su(f).createElement("img");return s.decoding="sync",s.loading="eager",s.src=i,s}function pn(i,f){return new Promise(s=>{const{timeout:o,ownerDocument:h,onError:m,onWarn:p}=f!=null?f:{},b=typeof i=="string"?Ea(i,Su(h)):i;let S=null,v=null;function x(){s(b),S&&clearTimeout(S),v==null||v()}if(o&&(S=setTimeout(x,o)),pu(b)){const _=b.currentSrc||b.src;if(!_)return b.poster?pn(b.poster,f).then(s):x();if(b.readyState>=2)return x();const R=x,N=B=>{p==null||p("Failed video load",_,B),m==null||m(B),x()};v=()=>{b.removeEventListener("loadeddata",R),b.removeEventListener("error",N)},b.addEventListener("loadeddata",R,{once:!0}),b.addEventListener("error",N,{once:!0})}else{const _=Vf(b)?b.href.baseVal:b.currentSrc||b.src;if(!_)return x();const R=async()=>{if(Sa(b)&&"decode"in b)try{await b.decode()}catch(B){p==null||p("Failed to decode image, trying to render anyway",b.dataset.originalSrc||_,B)}x()},N=B=>{p==null||p("Failed image load",b.dataset.originalSrc||_,B),x()};if(Sa(b)&&b.complete)return R();v=()=>{b.removeEventListener("load",R),b.removeEventListener("error",N)},b.addEventListener("load",R,{once:!0}),b.addEventListener("error",N,{once:!0})}})}async function Rm(i,f){bn(i)&&(Sa(i)||pu(i)?await pn(i,f):await Promise.all(["img","video"].flatMap(s=>Array.from(i.querySelectorAll(s)).map(o=>pn(o,f)))))}const Jf=(function(){let f=0;const s=()=>`0000${(Math.random()*36**4<<0).toString(36)}`.slice(-4);return()=>(f+=1,`u${s()}${f}`)})();function $f(i){return i==null?void 0:i.split(",").map(f=>f.trim().replace(/"|'/g,"").toLowerCase()).filter(Boolean)}let Wf=0;function Nm(i){const f=`${Qf}[#${Wf}]`;return Wf++,{time:s=>i&&console.time(`${f} ${s}`),timeEnd:s=>i&&console.timeEnd(`${f} ${s}`),warn:(...s)=>i&&Mm(...s)}}function Hm(i){return{cache:i?"no-cache":"force-cache"}}async function Ff(i,f){return hm(i)?i:Bm(i,hn(pt({},f),{autoDestruct:!0}))}async function Bm(i,f){var N,B,Y,k,j;const{scale:s=1,workerUrl:o,workerNumber:h=1}=f||{},m=!!(f!=null&&f.debug),p=(N=f==null?void 0:f.features)!=null?N:!0,b=(B=i.ownerDocument)!=null?B:pa?window.document:void 0,S=(k=(Y=i.ownerDocument)==null?void 0:Y.defaultView)!=null?k:pa?window:void 0,v=new Map,x=hn(pt({width:0,height:0,quality:1,type:"image/png",scale:s,backgroundColor:null,style:null,filter:null,maximumCanvasSize:0,timeout:3e4,progress:null,debug:m,fetch:pt({requestInit:Hm((j=f==null?void 0:f.fetch)==null?void 0:j.bypassingCache),placeholderImage:"data:image/png;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",bypassingCache:!1},f==null?void 0:f.fetch),fetchFn:null,font:{},drawImageInterval:100,workerUrl:null,workerNumber:h,onCloneEachNode:null,onCloneNode:null,onEmbedNode:null,onCreateForeignObjectSvg:null,includeStyleProperties:null,autoDestruct:!1},f),{__CONTEXT__:!0,log:Nm(m),node:i,ownerDocument:b,ownerWindow:S,dpi:s===1?null:96*s,svgStyleElement:If(b),svgDefsElement:b==null?void 0:b.createElementNS(Eu,"defs"),svgStyles:new Map,defaultComputedStyles:new Map,workers:[...Array.from({length:dm&&o&&h?h:0})].map(()=>{try{const Z=new Worker(o);return Z.onmessage=async q=>{var $,V,te,Ee;const{url:G,result:J}=q.data;J?(V=($=v.get(G))==null?void 0:$.resolve)==null||V.call($,J):(Ee=(te=v.get(G))==null?void 0:te.reject)==null||Ee.call(te,new Error(`Error receiving message from worker: ${G}`))},Z.onmessageerror=q=>{var J,$;const{url:G}=q.data;($=(J=v.get(G))==null?void 0:J.reject)==null||$.call(J,new Error(`Error receiving message from worker: ${G}`))},Z}catch(Z){return x.log.warn("Failed to new Worker",Z),null}}).filter(Boolean),fontFamilies:new Map,fontCssTexts:new Map,acceptOfImage:`${[_m(b)&&"image/webp","image/svg+xml","image/*","*/*"].filter(Boolean).join(",")};q=0.8`,requests:v,drawImageCount:0,tasks:[],features:p,isEnable:Z=>{var q,G;return Z==="restoreScrollPosition"?typeof p=="boolean"?!1:(q=p[Z])!=null?q:!1:typeof p=="boolean"?p:(G=p[Z])!=null?G:!0},shadowRoots:[]});x.log.time("wait until load"),await Rm(i,{timeout:x.timeout,onWarn:x.log.warn}),x.log.timeEnd("wait until load");const{width:_,height:R}=km(i,x);return x.width=_,x.height=R,x}function If(i){if(!i)return;const f=i.createElement("style"),s=f.ownerDocument.createTextNode(`
.______background-clip--text {
  background-clip: text;
  -webkit-background-clip: text;
}
`);return f.appendChild(s),f}function km(i,f){let{width:s,height:o}=f;if(Jt(i)&&(!s||!o)){const h=i.getBoundingClientRect();s=s||h.width||Number(i.getAttribute("width"))||0,o=o||h.height||Number(i.getAttribute("height"))||0}return{width:s,height:o}}async function qm(i,f){const{log:s,timeout:o,drawImageCount:h,drawImageInterval:m}=f;s.time("image to canvas");const p=await pn(i,{timeout:o,onWarn:f.log.warn}),{canvas:b,context2d:S}=Lm(i.ownerDocument,f),v=()=>{try{S==null||S.drawImage(p,0,0,b.width,b.height)}catch(x){f.log.warn("Failed to drawImage",x)}};if(v(),f.isEnable("fixSvgXmlDecode"))for(let x=0;x<h;x++)await new Promise(_=>{setTimeout(()=>{S==null||S.clearRect(0,0,b.width,b.height),v(),_()},x+m)});return f.drawImageCount=0,s.timeEnd("image to canvas"),b}function Lm(i,f){const{width:s,height:o,scale:h,backgroundColor:m,maximumCanvasSize:p}=f,b=i.createElement("canvas");b.width=Math.floor(s*h),b.height=Math.floor(o*h),b.style.width=`${s}px`,b.style.height=`${o}px`,p&&(b.width>p||b.height>p)&&(b.width>p&&b.height>p?b.width>b.height?(b.height*=p/b.width,b.width=p):(b.width*=p/b.height,b.height=p):b.width>p?(b.height*=p/b.width,b.width=p):(b.width*=p/b.height,b.height=p));const S=b.getContext("2d");return S&&m&&(S.fillStyle=m,S.fillRect(0,0,b.width,b.height)),{canvas:b,context2d:S}}function Pf(i,f){if(i.ownerDocument)try{const m=i.toDataURL();if(m!=="data:,")return Ea(m,i.ownerDocument)}catch(m){f.log.warn("Failed to clone canvas",m)}const s=i.cloneNode(!1),o=i.getContext("2d"),h=s.getContext("2d");try{return o&&h&&h.putImageData(o.getImageData(0,0,i.width,i.height),0,0),s}catch(m){f.log.warn("Failed to clone canvas",m)}return s}function Ym(i,f){var s;try{if((s=i==null?void 0:i.contentDocument)!=null&&s.body)return ic(i.contentDocument.body,f)}catch(o){f.log.warn("Failed to clone iframe",o)}return i.cloneNode(!1)}function jm(i){const f=i.cloneNode(!1);return i.currentSrc&&i.currentSrc!==i.src&&(f.src=i.currentSrc,f.srcset=""),f.loading==="lazy"&&(f.loading="eager"),f}async function Gm(i,f){if(i.ownerDocument&&!i.currentSrc&&i.poster)return Ea(i.poster,i.ownerDocument);const s=i.cloneNode(!1);s.crossOrigin="anonymous",i.currentSrc&&i.currentSrc!==i.src&&(s.src=i.currentSrc);const o=s.ownerDocument;if(o){let h=!0;if(await pn(s,{onError:()=>h=!1,onWarn:f.log.warn}),!h)return i.poster?Ea(i.poster,i.ownerDocument):s;s.currentTime=i.currentTime,await new Promise(p=>{s.addEventListener("seeked",p,{once:!0})});const m=o.createElement("canvas");m.width=i.offsetWidth,m.height=i.offsetHeight;try{const p=m.getContext("2d");p&&p.drawImage(s,0,0,m.width,m.height)}catch(p){return f.log.warn("Failed to clone video",p),i.poster?Ea(i.poster,i.ownerDocument):s}return Pf(m,f)}return s}function Xm(i,f){return pm(i)?Pf(i,f):Am(i)?Ym(i,f):Sa(i)?jm(i):pu(i)?Gm(i,f):i.cloneNode(!1)}function Qm(i){let f=i.sandbox;if(!f){const{ownerDocument:s}=i;try{s&&(f=s.createElement("iframe"),f.id=`__SANDBOX__${Jf()}`,f.width="0",f.height="0",f.style.visibility="hidden",f.style.position="fixed",s.body.appendChild(f),f.srcdoc='<!DOCTYPE html><meta charset="UTF-8"><title></title><body>',i.sandbox=f)}catch(o){i.log.warn("Failed to getSandBox",o)}}return f}const Zm=["width","height","-webkit-text-fill-color"],Vm=["stroke","fill"];function er(i,f,s){const{defaultComputedStyles:o}=s,h=i.nodeName.toLowerCase(),m=vn(i)&&h!=="svg",p=m?Vm.map(Y=>[Y,i.getAttribute(Y)]).filter(([,Y])=>Y!==null):[],b=[m&&"svg",h,p.map((Y,k)=>`${Y}=${k}`).join(","),f].filter(Boolean).join(":");if(o.has(b))return o.get(b);const S=Qm(s),v=S==null?void 0:S.contentWindow;if(!v)return new Map;const x=v==null?void 0:v.document;let _,R;m?(_=x.createElementNS(Eu,"svg"),R=_.ownerDocument.createElementNS(_.namespaceURI,h),p.forEach(([Y,k])=>{R.setAttributeNS(null,Y,k)}),_.appendChild(R)):_=R=x.createElement(h),R.textContent=" ",x.body.appendChild(_);const N=v.getComputedStyle(R,f),B=new Map;for(let Y=N.length,k=0;k<Y;k++){const j=N.item(k);Zm.includes(j)||B.set(j,N.getPropertyValue(j))}return x.body.removeChild(_),o.set(b,B),B}function tr(i,f,s){var b;const o=new Map,h=[],m=new Map;if(s)for(const S of s)p(S);else for(let S=i.length,v=0;v<S;v++){const x=i.item(v);p(x)}for(let S=h.length,v=0;v<S;v++)(b=m.get(h[v]))==null||b.forEach((x,_)=>o.set(_,x));function p(S){const v=i.getPropertyValue(S),x=i.getPropertyPriority(S),_=S.lastIndexOf("-"),R=_>-1?S.substring(0,_):void 0;if(R){let N=m.get(R);N||(N=new Map,m.set(R,N)),N.set(S,[v,x])}f.get(S)===v&&!x||(R?h.push(R):o.set(S,[v,x]))}return o}function Km(i,f,s,o){var _,R,N,B;const{ownerWindow:h,includeStyleProperties:m,currentParentNodeStyle:p}=o,b=f.style,S=h.getComputedStyle(i),v=er(i,null,o);p==null||p.forEach((Y,k)=>{v.delete(k)});const x=tr(S,v,m);x.delete("transition-property"),x.delete("all"),x.delete("d"),x.delete("content"),s&&(x.delete("margin-top"),x.delete("margin-right"),x.delete("margin-bottom"),x.delete("margin-left"),x.delete("margin-block-start"),x.delete("margin-block-end"),x.delete("margin-inline-start"),x.delete("margin-inline-end"),x.set("box-sizing",["border-box",""])),((_=x.get("background-clip"))==null?void 0:_[0])==="text"&&f.classList.add("______background-clip--text"),Zf&&(x.has("font-kerning")||x.set("font-kerning",["normal",""]),(((R=x.get("overflow-x"))==null?void 0:R[0])==="hidden"||((N=x.get("overflow-y"))==null?void 0:N[0])==="hidden")&&((B=x.get("text-overflow"))==null?void 0:B[0])==="ellipsis"&&i.scrollWidth===i.clientWidth&&x.set("text-overflow",["clip",""]));for(let Y=b.length,k=0;k<Y;k++)b.removeProperty(b.item(k));return x.forEach(([Y,k],j)=>{b.setProperty(j,Y,k)}),x}function Jm(i,f){(Sm(i)||Em(i)||zm(i))&&f.setAttribute("value",i.value)}const $m=["::before","::after"],Wm=["::-webkit-scrollbar","::-webkit-scrollbar-button","::-webkit-scrollbar-thumb","::-webkit-scrollbar-track","::-webkit-scrollbar-track-piece","::-webkit-scrollbar-corner","::-webkit-resizer"];function Fm(i,f,s,o,h){const{ownerWindow:m,svgStyleElement:p,svgStyles:b,currentNodeStyle:S}=o;if(!p||!m)return;function v(x){var q;const _=m.getComputedStyle(i,x);let R=_.getPropertyValue("content");if(!R||R==="none")return;h==null||h(R),R=R.replace(/(')|(")|(counter\(.+\))/g,"");const N=[Jf()],B=er(i,x,o);S==null||S.forEach((G,J)=>{B.delete(J)});const Y=tr(_,B,o.includeStyleProperties);Y.delete("content"),Y.delete("-webkit-locale"),((q=Y.get("background-clip"))==null?void 0:q[0])==="text"&&f.classList.add("______background-clip--text");const k=[`content: '${R}';`];if(Y.forEach(([G,J],$)=>{k.push(`${$}: ${G}${J?" !important":""};`)}),k.length===1)return;try{f.className=[f.className,...N].join(" ")}catch(G){o.log.warn("Failed to copyPseudoClass",G);return}const j=k.join(`
  `);let Z=b.get(j);Z||(Z=[],b.set(j,Z)),Z.push(`.${N[0]}${x}`)}$m.forEach(v),s&&Wm.forEach(v)}const lr=new Set(["symbol"]);async function ar(i,f,s,o,h){if(Jt(s)&&(xm(s)||Tm(s))||o.filter&&!o.filter(s))return;lr.has(f.nodeName)||lr.has(s.nodeName)?o.currentParentNodeStyle=void 0:o.currentParentNodeStyle=o.currentNodeStyle;const m=await ic(s,o,!1,h);o.isEnable("restoreScrollPosition")&&Im(i,m),f.appendChild(m)}async function nr(i,f,s,o){var m;let h=i.firstChild;Jt(i)&&i.shadowRoot&&(h=(m=i.shadowRoot)==null?void 0:m.firstChild,s.shadowRoots.push(i.shadowRoot));for(let p=h;p;p=p.nextSibling)if(!vm(p))if(Jt(p)&&wm(p)&&typeof p.assignedNodes=="function"){const b=p.assignedNodes();for(let S=0;S<b.length;S++)await ar(i,f,b[S],s,o)}else await ar(i,f,p,s,o)}function Im(i,f){if(!bn(i)||!bn(f))return;const{scrollTop:s,scrollLeft:o}=i;if(!s&&!o)return;const{transform:h}=f.style,m=new DOMMatrix(h),{a:p,b,c:S,d:v}=m;m.a=1,m.b=0,m.c=0,m.d=1,m.translateSelf(-o,-s),m.a=p,m.b=b,m.c=S,m.d=v,f.style.transform=m.toString()}function Pm(i,f){const{backgroundColor:s,width:o,height:h,style:m}=f,p=i.style;if(s&&p.setProperty("background-color",s,"important"),o&&p.setProperty("width",`${o}px`,"important"),h&&p.setProperty("height",`${h}px`,"important"),m)for(const b in m)p[b]=m[b]}const eg=/^[\w-:]+$/;async function ic(i,f,s=!1,o){var v,x,_,R;const{ownerDocument:h,ownerWindow:m,fontFamilies:p,onCloneEachNode:b}=f;if(h&&bm(i))return o&&/\S/.test(i.data)&&o(i.data),h.createTextNode(i.data);if(h&&m&&Jt(i)&&(bn(i)||vn(i))){const N=await Xm(i,f);if(f.isEnable("removeAbnormalAttributes")){const q=N.getAttributeNames();for(let G=q.length,J=0;J<G;J++){const $=q[J];eg.test($)||N.removeAttribute($)}}const B=f.currentNodeStyle=Km(i,N,s,f);s&&Pm(N,f);let Y=!1;if(f.isEnable("copyScrollbar")){const q=[(v=B.get("overflow-x"))==null?void 0:v[0],(x=B.get("overflow-y"))==null?void 0:x[0]];Y=q.includes("scroll")||(q.includes("auto")||q.includes("overlay"))&&(i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)}const k=(_=B.get("text-transform"))==null?void 0:_[0],j=$f((R=B.get("font-family"))==null?void 0:R[0]),Z=j?q=>{k==="uppercase"?q=q.toUpperCase():k==="lowercase"?q=q.toLowerCase():k==="capitalize"&&(q=q[0].toUpperCase()+q.substring(1)),j.forEach(G=>{let J=p.get(G);J||p.set(G,J=new Set),q.split("").forEach($=>J.add($))})}:void 0;return Fm(i,N,Y,f,Z),Jm(i,N),pu(i)||await nr(i,N,f,Z),await(b==null?void 0:b(N)),N}const S=i.cloneNode(!1);return await nr(i,S,f),await(b==null?void 0:b(S)),S}function tg(i){if(i.ownerDocument=void 0,i.ownerWindow=void 0,i.svgStyleElement=void 0,i.svgDefsElement=void 0,i.svgStyles.clear(),i.defaultComputedStyles.clear(),i.sandbox){try{i.sandbox.remove()}catch(f){i.log.warn("Failed to destroyContext",f)}i.sandbox=void 0}i.workers=[],i.fontFamilies.clear(),i.fontCssTexts.clear(),i.requests.clear(),i.tasks=[],i.shadowRoots=[]}function lg(i){const b=i,{url:f,timeout:s,responseType:o}=b,h=bh(b,["url","timeout","responseType"]),m=new AbortController,p=s?setTimeout(()=>m.abort(),s):void 0;return fetch(f,pt({signal:m.signal},h)).then(S=>{if(!S.ok)throw new Error("Failed fetch, not 2xx response",{cause:S});switch(o){case"arrayBuffer":return S.arrayBuffer();case"dataUrl":return S.blob().then(Um);default:return S.text()}}).finally(()=>clearTimeout(p))}function Sn(i,f){const{url:s,requestType:o="text",responseType:h="text",imageDom:m}=f;let p=s;const{timeout:b,acceptOfImage:S,requests:v,fetchFn:x,fetch:{requestInit:_,bypassingCache:R,placeholderImage:N},font:B,workers:Y,fontFamilies:k}=i;o==="image"&&(bu||nc)&&i.drawImageCount++;let j=v.get(s);if(!j){R&&R instanceof RegExp&&R.test(p)&&(p+=(/\?/.test(p)?"&":"?")+new Date().getTime());const Z=o.startsWith("font")&&B&&B.minify,q=new Set;Z&&o.split(";")[1].split(",").forEach(V=>{k.has(V)&&k.get(V).forEach(te=>q.add(te))});const G=Z&&q.size,J=pt({url:p,timeout:b,responseType:G?"arrayBuffer":h,headers:o==="image"?{accept:S}:void 0},_);j={type:o,resolve:void 0,reject:void 0,response:null},j.response=(async()=>{if(x&&o==="image"){const $=await x(s);if($)return $}return!bu&&s.startsWith("http")&&Y.length?new Promise(($,V)=>{Y[v.size&Y.length-1].postMessage(pt({rawUrl:s},J)),j.resolve=$,j.reject=V}):lg(J)})().catch($=>{if(v.delete(s),o==="image"&&N)return i.log.warn("Failed to fetch image base64, trying to use placeholder image",p),typeof N=="string"?N:N(m);throw $}),v.set(s,j)}return j.response}async function ur(i,f,s,o){if(!ir(i))return i;for(const[h,m]of ag(i,f))try{const p=await Sn(s,{url:m,requestType:o?"image":"text",responseType:"dataUrl"});i=i.replace(ng(h),`$1${p}$3`)}catch(p){s.log.warn("Failed to fetch css data url",h,p)}return i}function ir(i){return/url\((['"]?)([^'"]+?)\1\)/.test(i)}const cr=/url\((['"]?)([^'"]+?)\1\)/g;function ag(i,f){const s=[];return i.replace(cr,(o,h,m)=>(s.push([m,Kf(m,f)]),o)),s.filter(([o])=>!uc(o))}function ng(i){const f=i.replace(/([.*+?^${}()|\[\]\/\\])/g,"\\$1");return new RegExp(`(url\\(['"]?)(${f})(['"]?\\))`,"g")}const ug=["background-image","border-image-source","-webkit-border-image","-webkit-mask-image","list-style-image"];function ig(i,f){return ug.map(s=>{const o=i.getPropertyValue(s);return!o||o==="none"?null:((bu||nc)&&f.drawImageCount++,ur(o,null,f,!0).then(h=>{!h||o===h||i.setProperty(s,h,i.getPropertyPriority(s))}))}).filter(Boolean)}function cg(i,f){if(Sa(i)){const s=i.currentSrc||i.src;if(!uc(s))return[Sn(f,{url:s,imageDom:i,requestType:"image",responseType:"dataUrl"}).then(o=>{o&&(i.srcset="",i.dataset.originalSrc=s,i.src=o||"")})];(bu||nc)&&f.drawImageCount++}else if(vn(i)&&!uc(i.href.baseVal)){const s=i.href.baseVal;return[Sn(f,{url:s,imageDom:i,requestType:"image",responseType:"dataUrl"}).then(o=>{o&&(i.dataset.originalSrc=s,i.href.baseVal=o||"")})]}return[]}function og(i,f){var b;const{ownerDocument:s,svgDefsElement:o}=f,h=(b=i.getAttribute("href"))!=null?b:i.getAttribute("xlink:href");if(!h)return[];const[m,p]=h.split("#");if(p){const S=`#${p}`,v=f.shadowRoots.reduce((x,_)=>x!=null?x:_.querySelector(`svg ${S}`),s==null?void 0:s.querySelector(`svg ${S}`));if(m&&i.setAttribute("href",S),o!=null&&o.querySelector(S))return[];if(v)return o==null||o.appendChild(v.cloneNode(!0)),[];if(m)return[Sn(f,{url:m,responseType:"text"}).then(x=>{o==null||o.insertAdjacentHTML("beforeend",x)})]}return[]}function or(i,f){const{tasks:s}=f;Jt(i)&&((Sa(i)||Vf(i))&&s.push(...cg(i,f)),ym(i)&&s.push(...og(i,f))),bn(i)&&s.push(...ig(i.style,f)),i.childNodes.forEach(o=>{or(o,f)})}async function fg(i,f){const{ownerDocument:s,svgStyleElement:o,fontFamilies:h,fontCssTexts:m,tasks:p,font:b}=f;if(!(!s||!o||!h.size))if(b&&b.cssText){const S=rr(b.cssText,f);o.appendChild(s.createTextNode(`${S}
`))}else{const S=Array.from(s.styleSheets).filter(x=>{try{return"cssRules"in x&&!!x.cssRules.length}catch(_){return f.log.warn(`Error while reading CSS rules from ${x.href}`,_),!1}});await Promise.all(S.flatMap(x=>Array.from(x.cssRules).map(async(_,R)=>{if(gm(_)){let N=R+1;const B=_.href;let Y="";try{Y=await Sn(f,{url:B,requestType:"text",responseType:"text"})}catch(j){f.log.warn(`Error fetch remote css import from ${B}`,j)}const k=Y.replace(cr,(j,Z,q)=>j.replace(q,Kf(q,B)));for(const j of sg(k))try{x.insertRule(j,j.startsWith("@import")?N+=1:x.cssRules.length)}catch(Z){f.log.warn("Error inserting rule from remote css import",{rule:j,error:Z})}}}))),S.flatMap(x=>Array.from(x.cssRules)).filter(x=>{var _;return mm(x)&&ir(x.style.getPropertyValue("src"))&&((_=$f(x.style.getPropertyValue("font-family")))==null?void 0:_.some(R=>h.has(R)))}).forEach(x=>{const _=x,R=m.get(_.cssText);R?o.appendChild(s.createTextNode(`${R}
...
`))}))})}}const rg=/(\/\*[\s\S]*?\*\/)/g,fr=/((@.*?keyframes [\s\S]*?){([\s\S]*?}\s*?)})/gi;function sg(i){if(i==null)return[];const f=[];let s=i.replace(rg,"");for(;;){const m=fr.exec(s);if(!m)break;f.push(m[0])}s=s.replace(fr,"");const o=/@import[\s\S]*?url\([^)]*\)[\s\S]*?;/gi,h=new RegExp("((\\s*?(?:\\/\\*[\\s\\S]*?\\*\\/)?\\s*?@media[\\s\\S]*?){([\\s\\S]*?)}\\s*?})|(([\\s\\S]*?){([\\s\\S]*?)})","gi");for(;;){let m=o.exec(s);if(m)h.lastIndex=o.lastIndex;else if(m=h.exec(s),m)o.lastIndex=h.lastIndex;else break;f.push(m[0])}return f}const dg=/url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g,hg=/src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;function rr(i,f){const{font:s}=f,o=s?s==null?void 0:s.preferredFormat:void 0;return o?i.replace(hg,h=>{for(;;){const[m,,p]=dg.exec(h)||[];if(!p)return"";if(p===o)return`src: ${m};`}}):i}async function mg(i,f){const s=await Ff(i,f);if(Jt(s.node)&&vn(s.node))return s.node;const{ownerDocument:o,log:h,tasks:m,svgStyleElement:p,svgDefsElement:b,svgStyles:S,font:v,progress:x,autoDestruct:_,onCloneNode:R,onEmbedNode:N,onCreateForeignObjectSvg:B}=s;h.time("clone node");const Y=await ic(s.node,s,!0);if(p&&o){let G="";S.forEach((J,$)=>{G+=`${J.join(`,
`)} {
  ${$}
}
`}),p.appendChild(o.createTextNode(G))}h.timeEnd("clone node"),await(R==null?void 0:R(Y)),v!==!1&&Jt(Y)&&(h.time("embed web font"),await fg(Y,s),h.timeEnd("embed web font")),h.time("embed node"),or(Y,s);const k=m.length;let j=0;const Z=async()=>{for(;;){const G=m.pop();if(!G)break;try{await G}catch(J){s.log.warn("Failed to run task",J)}x==null||x(++j,k)}};x==null||x(j,k),await Promise.all([...Array.from({length:4})].map(Z)),h.timeEnd("embed node"),await(N==null?void 0:N(Y));const q=gg(Y,s);return b&&q.insertBefore(b,q.children[0]),p&&q.insertBefore(p,q.children[0]),_&&tg(s),await(B==null?void 0:B(q)),q}function gg(i,f){const{width:s,height:o}=f,h=Dm(s,o,i.ownerDocument),m=h.ownerDocument.createElementNS(h.namespaceURI,"foreignObject");return m.setAttributeNS(null,"x","0%"),m.setAttributeNS(null,"y","0%"),m.setAttributeNS(null,"width","100%"),m.setAttributeNS(null,"height","100%"),m.append(i),h.appendChild(m),h}async function yg(i,f){var p;const s=await Ff(i,f),o=await mg(s),h=Cm(o,s.isEnable("removeControlCharacter"));s.autoDestruct||(s.svgStyleElement=If(s.ownerDocument),s.svgDefsElement=(p=s.ownerDocument)==null?void 0:p.createElementNS(Eu,"defs"),s.svgStyles.clear());const m=Ea(h,o.ownerDocument);return await qm(m,s)}const xu=2e3;function vg(){return`screenshot-${Date.now()}-${Math.random().toString(36).slice(2,9)}`}function sr(i,f,s,o,h){const m=document.createElement("canvas");m.width=Math.max(1,Math.round(i*h)),m.height=Math.max(1,Math.round(f*h));const p=m.getContext("2d");return p&&(p.fillStyle="#f0f0f0",p.fillRect(0,0,m.width,m.height),p.strokeStyle="#00A3E1",p.lineWidth=2,p.strokeRect(1,1,m.width-2,m.height-2),p.fillStyle="#333",p.font="14px sans-serif",p.textAlign="center",p.textBaseline="middle",p.fillText(`Region: ${i}x${f}`,m.width/2,m.height/2-10),p.fillText(`at (${s}, ${o})`,m.width/2,m.height/2+10)),m}async function bg(i,f,s,o){let h=1;(s>xu||o>xu)&&(h=Math.min(xu/s,xu/o));let m;try{const p=await yg(document.body,{scale:h,filter:S=>{var v;return S instanceof Element?!((v=S.hasAttribute)!=null&&v.call(S,"data-feedback-widget")):!0}});m=document.createElement("canvas"),m.width=Math.round(s*h),m.height=Math.round(o*h);const b=m.getContext("2d");b&&b.drawImage(p,i*h,f*h,s*h,o*h,0,0,m.width,m.height)}catch(p){console.warn("[FeedbackWidget] modern-screenshot failed, using placeholder:",p),m=sr(s,o,i,f,h)}return new Promise(p=>{m.toBlob(b=>{b?p(b):(console.warn("[FeedbackWidget] Canvas toBlob failed, creating placeholder"),sr(s,o,i,f,h).toBlob(v=>{p(v||new Blob(["placeholder"],{type:"image/png"}))},"image/png"))},"image/png",1)})}async function pg(i,f,s,o){const h=await bg(i,f,s,o),m=URL.createObjectURL(h);return{id:vg(),blobUrl:m,region:{x:i,y:f,width:s,height:o},capturedAt:Date.now(),sizeBytes:h.size}}function Tu(i){URL.revokeObjectURL(i.blobUrl)}const cc=5;function Sg({shadowRootRef:i}){const[f,s]=K.useState([]),[o,h]=K.useState([]),[m,p]=K.useState(null),[b,S]=K.useState(!1),v=K.useRef(null);K.useEffect(()=>()=>{v.current&&clearTimeout(v.current),f.forEach(k=>Tu(k))},[]);const x=K.useCallback(k=>{p(k),v.current&&clearTimeout(v.current),v.current=setTimeout(()=>{p(null)},2e3)},[]),_=K.useCallback(k=>{s(j=>{const Z=j[k];return Z&&Tu(Z),j.filter((q,G)=>G!==k)}),h(j=>j.filter((q,G)=>G!==k).map((q,G)=>hn(pt({},q),{number:G+1})))},[]),R=K.useCallback(()=>{f.forEach(k=>Tu(k)),s([]),h([]),S(!1)},[f]),N=K.useCallback(()=>{S(k=>!k)},[]),B=K.useCallback(k=>{if(!i.current)return;const j=i.current,Z=j.querySelector("[data-preview-overlay]");Z&&Z.remove();const q=document.createElement("div");q.className="screenshot-preview-overlay",q.setAttribute("data-preview-overlay",""),q.innerHTML=`
